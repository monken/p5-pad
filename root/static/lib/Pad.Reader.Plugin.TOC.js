Role('Pad.Reader.Role.TOC', {
    after: {
        afterRender: function() {
            console.log(this);
            this.body.insertHtml('afterBegin', '<div class="x-toolbar pad-toc-container" id="pad-toc-container"><div class="pad-toc-tree" id="pad-toc-tree"></div>T<br>O<br>C<div class="pad-toc-tool" id="pad-toc-tool"></div></div>');
